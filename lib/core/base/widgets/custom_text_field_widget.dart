...
import 'package:flutter_task_astha_it/core/base/widgets/custom_animated_size.dart';
...
class CustomTextFormField
  ...
  const CustomTextFormField({
    ...
    this.autofillHints,
    this.style,
    this.onChangeDebouncer = const Duration(
      milliseconds:
          500,
    ),
    ...
    this.loadingIconsSize =
        24,
    this.showPrefixLoadingIcon =
        false,
    this.showSuffixLoadingIcon =
        false,
    this.fillColor,
    this.hintStyle,
    this.errorStyle,
        ...
        Focus(
          ...
          child: TextFormField(
                ...
                debounce = Timer(
                  ...
                  () async {
                    while (isIdle &&
                      ...
                      await widget.onChangedProcessing!(
                        searchingProduct,
                      );
                      if (mounted)
                        setState(
            ...
            decoration: InputDecoration(
              ...
              focusedErrorBorder:
                  widget.focusedErrorBorder?.copyWith(
                    borderSide: BorderSide(
                      width:
                          2,
                      color: Theme.of(
              ...
              disabledBorder:
                  widget.disabledBorder?.copyWith(
                    borderSide: BorderSide(
                      width:
                          2,
                      color: Theme.of(
